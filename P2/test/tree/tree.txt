...
int main() {
	tree_t t1 = tree_make(1, tree_make(2, tree_make(4, tree_make(6, tree_make(), tree_make()), tree_make(8, tree_make(), tree_make(10, tree_make(), tree_make()))), tree_make(5, tree_make(), tree_make())), tree_make(3, tree_make(6, tree_make(4, tree_make(), tree_make()), tree_make()), tree_make(7, tree_make(2, tree_make(), tree_make()), tree_make(9, tree_make(), tree_make()))));
	cout<<"Tree t1"<<endl;
	tree_print(t1);
	cout<<endl;
	...
	cout<<endl;
	tree_t t2 = tree_make(3, tree_make(8, tree_make(4, tree_make(6, tree_make(), tree_make()), tree_make(8, tree_make(), tree_make(10, tree_make(), tree_make()))), tree_make(5, tree_make(), tree_make())), tree_make(3, tree_make(6, tree_make(4, tree_make(), tree_make()), tree_make()), tree_make(7, tree_make(11, tree_make(), tree_make()), tree_make(2, tree_make(), tree_make()))));
	cout<<"Tree t2"<<endl;
	tree_print(t2);
	cout<<endl;
	
	//tree_min
	cout<<"Minimum in tree t1 is: "<<tree_min(t1)<<endl;
	cout<<"Minimum in tree t2 is: "<<tree_min(t2)<<endl;

	//traversal
	cout<<"Traversal of tree t1 is: ";
	list_print(traversal(t1));
	cout<<endl;
	cout<<"Traversal of tree t2 is: ";
	list_print(traversal(t2));
	cout<<endl;

	cout<<endl;
	tree_t t3 = tree_make(4, tree_make(2, tree_make(1, tree_make(), tree_make()), tree_make(3, tree_make(), tree_make())), tree_make(6, tree_make(5, tree_make(), tree_make()), tree_make(7, tree_make(), tree_make())));
	cout<<"Tree t3"<<endl;
	tree_print(t3);
	cout<<endl;

	//traversal
	cout<<"Traversal of tree t3 is: ";
	list_print(traversal(t3));
	cout<<endl;
	
	cout<<endl;
	//tree_hasPathSum
	cout<<"Tree t1 has path sum 8?: ";
	if(tree_hasPathSum(t1, 8)) {
		cout<<"Yes"<<endl;
	}
	else {
		cout<<"No"<<endl;
	}
	cout<<"Tree t1 has path sum 14?: ";
	if(tree_hasPathSum(t1, 14)) {
		cout<<"Yes"<<endl;
	}
	else {
		cout<<"No"<<endl;
	}
	cout<<"Tree t1 has path sum 5?: ";
	...
	cout<<"Tree t1 has path sum 21?: ";
	if(tree_hasPathSum(t1, 21)) {
		cout<<"Yes"<<endl;
	}
	else {
		cout<<"No"<<endl;
	...
	cout<<endl;
	cout<<"Tree t2 has path sum 20?: ";
	if(tree_hasPathSum(t2, 20)) {
		cout<<"Yes"<<endl;
	}
	else {
		cout<<"No"<<endl;
	}
	cout<<"Tree t2 has path sum 21?: ";
	if(tree_hasPathSum(t2, 21)) {
		cout<<"Yes"<<endl;
	}
	else {
		cout<<"No"<<endl;
	}
	cout<<"Tree t2 has path sum 15?: ";
	if(tree_hasPathSum(t2, 15)) {
		cout<<"Yes"<<endl;
	}
	else {
		cout<<"No"<<endl;
	}
	cout<<"Tree t2 has path sum 30?: ";
	if(tree_hasPathSum(t2, 30)) {
		cout<<"Yes"<<endl;
	}
	else {
		cout<<"No"<<endl;
	...
	cout<<endl;
	tree_t t4 = tree_make(1, tree_make(2, tree_make(4, tree_make(), tree_make()), tree_make(5, tree_make(), tree_make())), tree_make(3, tree_make(6, tree_make(), tree_make()), tree_make(7, tree_make(), tree_make())));	
	cout<<"Tree t4"<<endl;
	tree_print(t4);
	cout<<endl;

	cout<<endl;
	tree_t t5 = tree_make(3, tree_make(8, tree_make(4, tree_make(), tree_make(8, tree_make(), tree_make(10, tree_make(), tree_make()))), tree_make(5, tree_make(), tree_make())), tree_make(3, tree_make(6, tree_make(4, tree_make(), tree_make()), tree_make()), tree_make(7, tree_make(), tree_make())));	
	cout<<"Tree t5"<<endl;
	tree_print(t5);
	cout<<endl;

	cout<<endl;
	tree_t t6 = tree_make(1, tree_make(2, tree_make(5, tree_make(), tree_make()), tree_make(4, tree_make(), tree_make())), tree_make(3, tree_make(6, tree_make(), tree_make()), tree_make(7, tree_make(), tree_make())));	
	cout<<"Tree t6"<<endl;
	tree_print(t6);
	cout<<endl;

	cout<<endl;
	tree_t t7 = tree_make(3, tree_make(8, tree_make(4, tree_make(), tree_make(9, tree_make(), tree_make(10, tree_make(), tree_make()))), tree_make(5, tree_make(), tree_make())), tree_make(3, tree_make(6, tree_make(4, tree_make(), tree_make()), tree_make()), tree_make(7, tree_make(), tree_make())));	
	cout<<"Tree t7"<<endl;
	tree_print(t7);
	cout<<endl;

	cout<<endl;
	tree_t t8 = tree_make(3, tree_make(8, tree_make(4, tree_make(), tree_make(9, tree_make(), tree_make(10, tree_make(), tree_make()))), tree_make(5, tree_make(), tree_make())), tree_make(3, tree_make(6, tree_make(4, tree_make(), tree_make()), tree_make()), tree_make(7, tree_make(), tree_make(1, tree_make(), tree_make()))));	
	cout<<"Tree t8"<<endl;
	tree_print(t8);
	cout<<endl;

	//covered_by
	cout<<"Is Tree t4 covered by t1?: ";
	if(covered_by(t4, t1)) {
		cout<<"Yes"<<endl;
	}
	else {
	...
	//contained_by
	cout<<endl;
	tree_t t9 = tree_make(1, tree_make(2, tree_make(), tree_make()), tree_make(3, tree_make(), tree_make()));
	cout<<"Tree t9"<<endl;
	tree_print(t9);
	cout<<endl;
	cout<<endl;
	tree_t t10 = tree_make(1, tree_make(2, tree_make(), tree_make()), tree_make(3, tree_make(6, tree_make(), tree_make()), tree_make(7, tree_make(), tree_make())));
	cout<<"Tree t10"<<endl;
	tree_print(t10);
	cout<<endl;
	cout<<endl;
	tree_t t11 = tree_make(3, tree_make(6, tree_make(4, tree_make(), tree_make()), tree_make(2, tree_make(), tree_make())), tree_make());
	cout<<"Tree t11"<<endl;
	tree_print(t11);
	cout<<endl;
	cout<<endl;
	tree_t t12 = tree_make(4, tree_make(), tree_make(8, tree_make(), tree_make()));
	cout<<"Tree t12"<<endl;
	tree_print(t12);
	cout<<endl;
	tree_t t13 = tree_make(10, tree_make(), tree_make());
	cout<<"Tree t13"<<endl;
	tree_print(t13);
	cout<<endl;
	tree_t t14 = tree_make(1, tree_make(2, tree_make(), tree_make()), tree_make(3, tree_make(), tree_make(7, tree_make(2, tree_make(), tree_make()), tree_make(9, tree_make(1, tree_make(), tree_make()), tree_make()))));
	cout<<"Tree t14"<<endl;
	tree_print(t14);
	cout<<endl;
	tree_t t15 = tree_make(1, tree_make(2, tree_make(4, tree_make(6, tree_make(), tree_make()), tree_make(8, tree_make(), tree_make(10, tree_make(), tree_make()))), tree_make(5, tree_make(), tree_make())), tree_make(3, tree_make(6, tree_make(4, tree_make(), tree_make()), tree_make(7, tree_make(), tree_make())), tree_make(7, tree_make(2, tree_make(), tree_make()), tree_make(9, tree_make(), tree_make()))));
	cout<<"Tree t15"<<endl;
	tree_print(t15);
	cout<<endl;
	cout<<endl;
	tree_t t16 = tree_make(3, tree_make(6, tree_make(4, tree_make(), tree_make()), tree_make()), tree_make());
	cout<<"Tree t16"<<endl;
	tree_print(t16);
	cout<<endl;

	cout<<"Is Tree t9 contained by t1?: ";
	if(contained_by(t9, t1)) {
		cout<<"Yes"<<endl;
	}
	else {
		cout<<"No"<<endl;
	}
	cout<<"Is Tree t10 contained by t1?: ";
	if(contained_by(t10, t1)) {
		cout<<"Yes"<<endl;
	}
	else {
		cout<<"No"<<endl;
	}
	cout<<"Is Tree t11 contained by t1?: ";
	if(contained_by(t11, t1)) {
		cout<<"Yes"<<endl;
	}
	else {
		cout<<"No"<<endl;
	}
	cout<<"Is Tree t12 contained by t1?: ";
	if(contained_by(t12, t1)) {
		cout<<"Yes"<<endl;
	}
	else {
		cout<<"No"<<endl;
	}
	cout<<"Is Tree t13 contained by t1?: ";
	if(contained_by(t13, t1)) {
		cout<<"Yes"<<endl;
	}
	else {
		cout<<"No"<<endl;
	}
	cout<<"Is Tree t14 contained by t1?: ";
	if(contained_by(t14, t1)) {
		cout<<"Yes"<<endl;
	}
	else {
		cout<<"No"<<endl;
	}
	cout<<"Is Tree t15 contained by t1?: ";
	if(contained_by(t15, t1)) {
		cout<<"Yes"<<endl;
	}
	else {
		cout<<"No"<<endl;
	}
	cout<<"Is Tree t16 contained by t1?: ";
	if(contained_by(t16, t1)) {
		cout<<"Yes"<<endl;
	}
	else {
		cout<<"No"<<endl;
	}
	cout<<"Is Tree t1 contained by t15?: ";
	if(contained_by(t1, t15)) {
		cout<<"Yes"<<endl;
	}
	else {
		cout<<"No"<<endl;
	...
	cout<<endl;
	tree_t t17 = tree_make(1, tree_make(2, tree_make(4, tree_make(6, tree_make(), tree_make()), tree_make(8, tree_make(), tree_make(10, tree_make(), tree_make()))), tree_make(5, tree_make(), tree_make())), tree_make(3, tree_make(6, tree_make(4, tree_make(), tree_make()), tree_make()), tree_make(7, tree_make(2, tree_make(), tree_make(5, tree_make(), tree_make())), tree_make(9, tree_make(), tree_make()))));
	cout<<"Tree t17"<<endl;
	tree_print(t17);
	cout<<endl;

	cout<<"Insert 5 in t1 is eqaul to t17?"<<endl;
    tree_t t18 = insert_tree(5, t1);
	cout<<"t18"<<endl;
	tree_print(t18);
	cout<<endl;

	cout<<"Traversal of tree t18 is: ";
	list_print(traversal(t18));
	cout<<endl;
	cout<<"Traversal of tree t17 is: ";
	list_print(traversal(t17));
	cout<<endl;

    if(tree_equal(t18, t17))
    {
        cout << "Yes!\n";
    }
    else
